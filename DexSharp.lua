--[[
    ...
    > Dex | Made by Moon
	> Dex++ | Developed by Chillz
	> Dex# | Modded by Gato 
	
	im not gonna be maintaining ts btw lol i made it to me to use if u want to use its on you :p
]]

-- im so lazy to mod the rest so fuck it guys we ball :v
writefile("DexSharpSettings.json", [[{"ScriptViewer":{"ShowMoreInfo":true},"RemoteBlockWriteAttribute":false,"Properties":{"ScaleType":0,"ShowAttributes":true,"ShowDeprecated":true,"MaxConflictCheck":50,"LoadstringInput":true,"ShowHidden":true,"ClearOnFocus":false,"NumberRounding":3,"_Recurse":true,"MaxAttributes":50},"Explorer":{"CopyPathUseGetChildren":true,"PartSelectionBox":true,"AutoUpdateMode":0,"AutoUpdateSearch":true,"Sorting":true,"GuiSelectionBox":true,"_Recurse":true,"ClickToRename":true},"Decompiler":{"PreferDecompilerFallback":false,"DecompilerFallback":"Konstant","ShinyDecompilerPort":3000},"Window":{"TitleOnMiddle":true,"Transparency":0.2},"Theme":{"Highlight":{"B":0.29411765933036806,"G":0.29411765933036806,"R":0.29411765933036806},"Main2":{"B":0.1764705926179886,"G":0.1764705926179886,"R":0.1764705926179886},"Main1":{"B":0.20392157137393952,"G":0.20392157137393952,"R":0.20392157137393952},"ButtonPress":{"B":0.1568627506494522,"G":0.1568627506494522,"R":0.1568627506494522},"ButtonHover":{"B":0.2666666805744171,"G":0.2666666805744171,"R":0.2666666805744171},"Button":{"B":0.23529411852359773,"G":0.23529411852359773,"R":0.23529411852359773},"PlaceholderText":{"B":0.3921568691730499,"G":0.3921568691730499,"R":0.3921568691730499},"Syntax":{"SelectionBack":{"B":0.686274528503418,"G":0.3529411852359772,"R":0.04313725605607033},"String":{"B":0.5843137502670288,"G":0.9450980424880981,"R":0.6784313917160034},"FunctionName":{"B":0.6745098233222961,"G":0.9843137264251709,"R":0.9921568632125855},"BuiltIn":{"B":0.9686274528503418,"G":0.8392156958580017,"R":0.5176470875740051},"CurrentLine":{"B":0.2549019753932953,"G":0.19607843458652497,"R":0.1764705926179886},"Keyword":{"B":0.48627451062202456,"G":0.4274509847164154,"R":0.9725490212440491},"MatchingWord":{"B":0.3333333432674408,"G":0.3333333432674408,"R":0.3333333432674408},"LocalMethod":{"B":0.6745098233222961,"G":0.9843137264251709,"R":0.9921568632125855},"Background":{"B":0.1411764770746231,"G":0.1411764770746231,"R":0.1411764770746231},"Bool":{"B":0,"G":0.7764706015586853,"R":1},"FindBackground":{"B":0,"G":0.4627451002597809,"R":0.5529412031173706},"Selection":{"B":1,"G":1,"R":1},"Text":{"B":0.800000011920929,"G":0.800000011920929,"R":0.800000011920929},"Nil":{"B":0,"G":0.7764706015586853,"R":1},"Operator":{"B":0.800000011920929,"G":0.800000011920929,"R":0.800000011920929},"Number":{"B":0,"G":0.7764706015586853,"R":1},"Bracket":{"B":0.800000011920929,"G":0.800000011920929,"R":0.800000011920929},"LocalProperty":{"B":0.9450980424880981,"G":0.6313725709915161,"R":0.3803921639919281},"Local":{"B":0.48627451062202456,"G":0.4274509847164154,"R":0.9725490212440491},"Function":{"B":0.48627451062202456,"G":0.4274509847164154,"R":0.9725490212440491},"Comment":{"B":0.4000000059604645,"G":0.4000000059604645,"R":0.4000000059604645},"Error":{"B":0,"G":0,"R":1},"Self":{"B":0.48627451062202456,"G":0.4274509847164154,"R":0.9725490212440491}},"ExplorerIconMap":"","ListSelection":{"B":0.686274528503418,"G":0.3529411852359772,"R":0.04313725605607033},"Important":{"B":0,"G":0,"R":1},"TextBox":{"B":0.14901961386203767,"G":0.14901961386203767,"R":0.14901961386203767},"Outline2":{"B":0.21568627655506135,"G":0.21568627655506135,"R":0.21568627655506135},"Menu":{"B":0.125490203499794,"G":0.125490203499794,"R":0.125490203499794},"Outline1":{"B":0.12941177189350129,"G":0.12941177189350129,"R":0.12941177189350129},"MiscIconMap":"","_Recurse":true,"Outline3":{"B":0.11764705926179886,"G":0.11764705926179886,"R":0.11764705926179886},"Text":{"B":1,"G":1,"R":1}},"ClassIcon":"Vanilla3"}]])
...
local legacyTweenTracker = setmetatable({}, {__mode = "k"})

local function resolveEasingDirection(value)
	if typeof(value) == "EnumItem" then
		return value
	elseif type(value) == "string" then
		return Enum.EasingDirection[value] or Enum.EasingDirection.Out
	end
...
local function resolveEasingStyle(value)
	if typeof(value) == "EnumItem" then
		return value
	elseif type(value) == "string" then
		return Enum.EasingStyle[value] or Enum.EasingStyle.Cubic
	end
	return Enum.EasingStyle.Cubic
end

local function playLegacyTween(object, propertyName, goal, easingDirection, easingStyle, time, override, callback)
	if not object then
		return nil
	end

	local propertyTweens = legacyTweenTracker[object]
	if not propertyTweens then
		propertyTweens = {}
		legacyTweenTracker[object] = propertyTweens
	end

	local existing = propertyTweens[propertyName]
	if existing and override ~= false then
		pcall(function()
			existing:Cancel()
		end)
	end
	...
	local ok, tween = pcall(function()
		return TweenService:Create(object, TweenInfo.new(time or 0, resolveEasingStyle(easingStyle), resolveEasingDirection(easingDirection)), {
			[propertyName] = goal
		})
	end)
	...
	propertyTweens[propertyName] = tween
	tween.Completed:Connect(function(state)
		if propertyTweens[propertyName] == tween then
			propertyTweens[propertyName] = nil
		end
		if callback and state == Enum.PlaybackState.Completed then
			pcall(callback)
		end
	end)
...
local function TweenSize(object, endSize, easingDirection, easingStyle, time, override, callback)
	return playLegacyTween(object, "Size", endSize, easingDirection, easingStyle, time, override, callback)
end

local function TweenPosition(object, endPosition, easingDirection, easingStyle, time, override, callback)
	return playLegacyTween(object, "Position", endPosition, easingDirection, easingStyle, time, override, callback)
end
...
local function main()
	...
	G2L["6"]["FontFace"] = Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal);
	...
	G2L["8"]["FontFace"] = Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal);
	...
	G2L["11"]["FontFace"] = Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal);
	...
	G2L["15"]["FontFace"] = Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal);
	...
	G2L["17"]["FontFace"] = Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal);
	...
	G2L["1a"]["FontFace"] = Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal);
	...
	G2L["1e"]["FontFace"] = Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal);
	...
	Console.Init = function()
		...
		if CtrlScroll == true then
			Console.CtrlScroll.BackgroundColor3 = Color3.fromRGB(0, 119, 255)
		...
		if AutoScroll == true then
			Console.AutoScroll.BackgroundColor3 = Color3.fromRGB(0, 119, 255)
...
return search]==]
	...
	Explorer.InitEntryTemplate = function()
		entryTemplate = create({
			{1,"TextButton",{AutoButtonColor=false,BackgroundColor3=Color3.new(0,0,0),BackgroundTransparency=1,BorderColor3=Color3.new(0,0,0),FontFace=Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal),Name="Entry",Position=UDim2.new(0,1,0,1),Size=UDim2.new(0,250,0,20),Text="",TextSize=14,}},
			...
			{3,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,FontFace=Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal),Name="EntryName",Parent={2},Position=UDim2.new(0,26,0,0),Size=UDim2.new(1,-26,1,0),Text="Workspace",TextColor3=Color3.new(0.86274516582489,0.86274516582489,0.86274516582489),TextSize=14,TextXAlignment=0,}},
			{4,"TextButton",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,ClipsDescendants=true,FontFace=Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal),Name="Expand",Parent={2},Position=UDim2.new(0,-20,0,0),Size=UDim2.new(0,20,0,20),Text="",TextSize=14,}},
	...
	Explorer.Init = function()
		...
		local explorerItems = create({
			...
			{4,"TextBox",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,ClearTextOnFocus=false,FontFace=Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal),Name="SearchBox",Parent={3},PlaceholderColor3=Color3.new(0.39215689897537,0.39215689897537,0.39215689897537),PlaceholderText="Search workspace",Position=UDim2.new(0,4,0,0),Size=UDim2.new(1,-24,0,18),Text="",TextColor3=Color3.new(1,1,1),TextSize=14,TextXAlignment=0,}},
			{5,"UICorner",{CornerRadius=UDim.new(0,2),Parent={3},}},
			{6,"UIStroke",{Thickness=1.4,Parent={3},Color=Color3.fromRGB(42,42,42)}},
			{7,"TextButton",{AutoButtonColor=false,BackgroundColor3=Color3.new(0.12549020349979,0.12549020349979,0.12549020349979),BackgroundTransparency=1,BorderSizePixel=0,FontFace=Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal),Name="Reset",Parent={3},Position=UDim2.new(1,-17,0,1),Size=UDim2.new(0,16,0,16),Text="",TextColor3=Color3.new(1,1,1),TextSize=14,}},
...
local function main()
	...
	Lib.Window = (function()
		...
		local sideTweenInfo = TweenInfo.new(0.3,Enum.EasingStyle.Cubic,Enum.EasingDirection.Out)
		local tweens = {}
		local isA = game.IsA
		...
		local createGui = function(self)
			local gui = create({
				...
				{6,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,FontFace=Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal),Name="Title",Parent={5},Position=UDim2.new(0,5,0,0),Size=UDim2.new(1,-10,0,20),Text="Window",TextColor3=Color3.new(1,1,1),TextSize=14,TextXAlignment=0}},
				{7,"TextButton",{AutoButtonColor=false,BackgroundColor3=Color3.new(0.12549020349979,0.12549020349979,0.12549020349979),BackgroundTransparency=1,BorderSizePixel=0,FontFace=Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal),Name="Close",Parent={5},Position=UDim2.new(1,-18,0,2),Size=UDim2.new(0,16,0,16),Text="",TextColor3=Color3.new(1,1,1),TextSize=14,}},
				...
				{15,"TextButton",{AutoButtonColor=false,BackgroundColor3=Color3.new(0.27450981736183,0.27450981736183,0.27450981736183),BackgroundTransparency=1,BorderSizePixel=0,FontFace=Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal),Name="North",Parent={14},Position=UDim2.new(0,5,0,0),Size=UDim2.new(1,-10,0,5),Text="",TextColor3=Color3.new(0,0,0),TextSize=14,}},
				{16,"TextButton",{AutoButtonColor=false,BackgroundColor3=Color3.new(0.27450981736183,0.27450981736183,0.27450981736183),BackgroundTransparency=1,BorderSizePixel=0,FontFace=Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal),Name="South",Parent={14},Position=UDim2.new(0,5,1,-5),Size=UDim2.new(1,-10,0,5),Text="",TextColor3=Color3.new(0,0,0),TextSize=14,}},
				{17,"TextButton",{AutoButtonColor=false,BackgroundColor3=Color3.new(0.27450981736183,0.27450981736183,0.27450981736183),BackgroundTransparency=1,BorderSizePixel=0,FontFace=Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal),Name="NorthEast",Parent={14},Position=UDim2.new(1,-5,0,0),Size=UDim2.new(0,5,0,5),Text="",TextColor3=Color3.new(0,0,0),TextSize=14,}},
				{18,"TextButton",{AutoButtonColor=false,BackgroundColor3=Color3.new(0.27450981736183,0.27450981736183,0.27450981736183),BackgroundTransparency=1,BorderSizePixel=0,FontFace=Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal),Name="East",Parent={14},Position=UDim2.new(1,-5,0,5),Size=UDim2.new(0,5,1,-10),Text="",TextColor3=Color3.new(0,0,0),TextSize=14,}},
				{19,"TextButton",{AutoButtonColor=false,BackgroundColor3=Color3.new(0.27450981736183,0.27450981736183,0.27450981736183),BackgroundTransparency=1,BorderSizePixel=0,FontFace=Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal),Name="West",Parent={14},Position=UDim2.new(0,0,0,5),Size=UDim2.new(0,5,1,-10),Text="",TextColor3=Color3.new(0,0,0),TextSize=14,}},
				{20,"TextButton",{AutoButtonColor=false,BackgroundColor3=Color3.new(0.27450981736183,0.27450981736183,0.27450981736183),BackgroundTransparency=1,BorderSizePixel=0,FontFace=Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal),Name="SouthEast",Parent={14},Position=UDim2.new(1,-5,1,-5),Size=UDim2.new(0,5,0,5),Text="",TextColor3=Color3.new(0,0,0),TextSize=14,}},
				{21,"TextButton",{AutoButtonColor=false,BackgroundColor3=Color3.new(0.27450981736183,0.27450981736183,0.27450981736183),BackgroundTransparency=1,BorderSizePixel=0,FontFace=Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal),Name="NorthWest",Parent={14},Size=UDim2.new(0,5,0,5),Text="",TextColor3=Color3.new(0,0,0),TextSize=14,}},
				{22,"TextButton",{AutoButtonColor=false,BackgroundColor3=Color3.new(0.27450981736183,0.27450981736183,0.27450981736183),BackgroundTransparency=1,BorderSizePixel=0,FontFace=Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal),Name="SouthWest",Parent={14},Position=UDim2.new(0,0,1,-5),Size=UDim2.new(0,5,0,5),Text="",TextColor3=Color3.new(0,0,0),TextSize=14,}},
			})
		...
		local function updateSideFrames(noTween)
			...
			--[[if #leftSide.Windows > 0 and leftSide.Frame.Position == UDim2.new(0,-leftSide.Width-5,0,0) then
				TweenPosition(leftSide.Frame,UDim2.new(0,0,0,0),Enum.EasingDirection.Out,Enum.EasingStyle.Cubic,0.3,true)
			elseif #leftSide.Windows == 0 and leftSide.Frame.Position == UDim2.new(0,0,0,0) then
				TweenPosition(leftSide.Frame,UDim2.new(0,-leftSide.Width-5,0,0),Enum.EasingDirection.Out,Enum.EasingStyle.Cubic,0.3,true)
			end
			local rightTweenPos = (#rightSide.Windows == 0 and UDim2.new(1,5,0,0) or UDim2.new(1,-rightSide.Width,0,0))
			TweenPosition(rightSide.Frame,rightTweenPos,Enum.EasingDirection.Out,Enum.EasingStyle.Cubic,0.3,true)]]
		...
		local function renderSide(side,noTween) -- TODO: Use existing resizers
			...
			for i,v in pairs(side.Windows) do
				...
				Lib.ShowGui(v.Gui)
				--v.GuiElems.Main:TweenSizeAndPosition(size,pos,Enum.EasingDirection.Out,Enum.EasingStyle.Cubic,0.3,true)
				if noTween then
		...
		updateWindows = function(noTween)
			...
			TweenPosition(leftSide.Frame,leftTweenPos,Enum.EasingDirection.Out,Enum.EasingStyle.Cubic,0.3,true)
			local rightTweenPos = (#rightSide.Windows == 0 and UDim2.new(1,5,0,0) or UDim2.new(1,-rightSide.Width,0,0))
			TweenPosition(rightSide.Frame,rightTweenPos,Enum.EasingDirection.Out,Enum.EasingStyle.Cubic,0.3,true)]]
		end
		...
		funcs.SetMinimized = function(self,set,mode)
			...
			if mode == 1 or mode == 2 then
				self:StopTweens()
				if mode == 1 then
					TweenSize(self.GuiElems.Main,UDim2.new(0,self.SizeX,0,newVal and 20 or self.SizeY),Enum.EasingDirection.Out,Enum.EasingStyle.Cubic,0.25,true)
				else
					...
					TweenPosition(self.GuiElems.Main,newPos,Enum.EasingDirection.Out,Enum.EasingStyle.Cubic,0.25,true)
					TweenSize(self.GuiElems.Main,UDim2.new(0,self.SizeX,0,newVal and 20 or self.SizeY),Enum.EasingDirection.Out,Enum.EasingStyle.Cubic,0.25,true)
				end
		...
		static.Init = function()
			...
			local leftFrame = create({
				...
				{2,"TextButton",{AutoButtonColor=false,BackgroundColor3=Color3.new(0.2549019753933,0.2549019753933,0.2549019753933),BorderSizePixel=0,FontFace=Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal),Name="Resizer",Parent={1},Size=UDim2.new(0,5,1,0),Text="",TextColor3=Color3.new(0,0,0),TextSize=14,}},
				...
				{4,"TextButton",{AutoButtonColor=false,BackgroundColor3=Color3.new(0.2549019753933,0.2549019753933,0.2549019753933),BorderSizePixel=0,FontFace=Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal),Name="WindowResizer",Parent={1},Position=UDim2.new(1,-300,0,0),Size=UDim2.new(1,0,0,4),Text="",TextColor3=Color3.new(0,0,0),TextSize=14,}},
	...
	Lib.ContextMenu = (function()
		...
		local function createGui(self)
			local contextGui = create({
				...
				{10,"TextBox",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,FontFace=Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal),Name="SearchBox",Parent={9},PlaceholderColor3=Color3.new(0.39215689897537,0.39215689897537,0.39215689897537),PlaceholderText="Search",Position=UDim2.new(0,4,0,0),Size=UDim2.new(1,-8,0,18),Text="",TextColor3=Color3.new(1,1,1),TextSize=14,TextXAlignment=0,}},
				...
				{13,"TextButton",{AutoButtonColor=false,BackgroundColor3=Color3.new(0.20392157137394,0.20392157137394,0.20392157137394),BackgroundTransparency=1,BorderColor3=Color3.new(0.33725491166115,0.49019610881805,0.73725491762161),BorderSizePixel=0,FontFace=Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal),Name="Entry",Parent={1},Size=UDim2.new(1,0,0,22),Text="",TextSize=14,Visible=false,}},
				{14,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,BorderSizePixel=0,FontFace=Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal),Name="EntryName",Parent={13},Position=UDim2.new(0,24,0,0),Size=UDim2.new(1,-24,1,0),Text="Duplicate",TextColor3=Color3.new(0.86274516582489,0.86274516582489,0.86274516582489),TextSize=14,TextXAlignment=0,}},
				{15,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,FontFace=Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal),Name="Shortcut",Parent={13},Position=UDim2.new(0,24,0,0),Size=UDim2.new(1,-30,1,0),Text="Ctrl+D",TextColor3=Color3.new(0.86274516582489,0.86274516582489,0.86274516582489),TextSize=14,TextXAlignment=1,}},
		...
		funcs.AddDivider = function(self,text)
			...
			local textWidth = text and service.TextService:GetTextSize(text,14,Enum.Font.Jura,Vector2.new(999999999,20)).X or nil
		...
		funcs.Show = function(self,x,y)
			...
			if reverseY then
				...
				elems.Main:TweenSizeAndPosition(UDim2.new(0,self.Width,0,toSize),UDim2.new(0,x,0,y),Enum.EasingDirection.Out,Enum.EasingStyle.Cubic,0.2,true)
			else
				TweenSize(elems.Main,UDim2.new(0,self.Width,0,toSize),Enum.EasingDirection.Out,Enum.EasingStyle.Cubic,0.2,true)
			end
	...
	Lib.CodeFrame = (function()
		...
		local function makeFrame(obj)
			...
			lineNumbersLabel.FontFace = Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal)
			...
			lineTweens.Invis = tweenService:Create(cursor,TweenInfo.new(0.4,Enum.EasingStyle.Cubic,Enum.EasingDirection.Out),{BackgroundTransparency = 1})
			lineTweens.Vis = tweenService:Create(cursor,TweenInfo.new(0.2,Enum.EasingStyle.Cubic,Enum.EasingDirection.Out),{BackgroundTransparency = 0})
		...
		funcs.Refresh = function(self)
			...
			for row = 1,maxLines do
				...
				if not lineFrame then
					...
					label.FontFace = Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal)
	...
	Lib.Checkbox = (function()
		...
		local LegacyTweenSize = new("Frame").TweenSize
		...
		local function ripple(object, color)
			...
			service.TweenService:Create(circle, ti(0.4, Enum.EasingStyle.Cubic, Enum.EasingDirection.Out), {BackgroundTransparency = 1}):Play()
		...
		funcs.SetState = function(self,val,anim)
			...
			if self.Toggled then
				if self.Style == 0 then
					if anim then
						self.OutlineColorTween = service.TweenService:Create(self.GuiElems.Outline, ti(4/15, Enum.EasingStyle.Cubic, Enum.EasingDirection.Out), {BackgroundColor3 = self.Colors.Primary})
				...
				if self.Style == 0 then
					if anim then
						self.OutlineColorTween = service.TweenService:Create(self.GuiElems.Outline, ti(4/15, Enum.EasingStyle.Cubic, Enum.EasingDirection.Out), {BackgroundColor3 = self.Colors.Secondary})
						self.OutlineColorTween:Play()
						delay(0.15, function()
							if setStateTime ~= self.LastSetStateTime then return end
							self:Paint()
	...
	Lib.BrickColorPicker = (function()
		...
		local function createGui(self)
			local gui = create({
				...
				{3,"TextButton",{BackgroundColor3=Color3.new(0.2352941185236,0.2352941185236,0.2352941185236),BorderColor3=Color3.new(0.21568627655506,0.21568627655506,0.21568627655506),BorderSizePixel=0,FontFace=Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal),Name="MoreColors",Parent={2},Position=UDim2.new(0,5,1,-30),Size=UDim2.new(1,-10,0,25),Text="More Colors",TextColor3=Color3.new(1,1,1),TextSize=14,}},
	...
	Lib.ColorPicker = (function() -- TODO: Convert to newer class model
		...
		local function new()
			...
			local guiContents = create({
				...
				{3,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,FontFace=Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal),Name="Title",Parent={2},Position=UDim2.new(0,0,0,-5),Size=UDim2.new(1,0,0,26),Text="Basic Colors",TextColor3=Color3.new(0.86274516582489,0.86274516582489,0.86274516582489),TextSize=14,TextXAlignment=0,}},
				...
				{5,"TextBox",{BackgroundColor3=Color3.new(0.25098040699959,0.25098040699959,0.25098040699959),BackgroundTransparency=1,BorderColor3=Color3.new(0.37647062540054,0.37647062540054,0.37647062540054),FontFace=Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal),Name="Input",Parent={4},Position=UDim2.new(0,2,0,0),Size=UDim2.new(0,50,0,16),Text="0",TextColor3=Color3.new(0.86274516582489,0.86274516582489,0.86274516582489),TextSize=14,TextXAlignment=0,}},
				...
				{7,"TextButton",{AutoButtonColor=false,BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,BorderSizePixel=0,FontFace=Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal),Name="Up",Parent={6},Size=UDim2.new(1,0,0,8),Text="",TextSize=14,}},
				...
				{12,"TextButton",{AutoButtonColor=false,BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,BorderSizePixel=0,FontFace=Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal),Name="Down",Parent={6},Position=UDim2.new(0,0,0,8),Size=UDim2.new(1,0,0,8),Text="",TextSize=14,}},
				...
				{17,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,FontFace=Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal),Name="Title",Parent={4},Position=UDim2.new(0,-40,0,0),Size=UDim2.new(0,34,1,0),Text="Blue:",TextColor3=Color3.new(0.86274516582489,0.86274516582489,0.86274516582489),TextSize=14,TextXAlignment=1,}},
				...
				{24,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,FontFace=Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal),Name="Title",Parent={23},Size=UDim2.new(1,0,0,20),Text="Custom Colors (RC = Set)",TextColor3=Color3.new(0.86274516582489,0.86274516582489,0.86274516582489),TextSize=14,TextXAlignment=0,}},
				...
				{26,"TextBox",{BackgroundColor3=Color3.new(0.25098040699959,0.25098040699959,0.25098040699959),BackgroundTransparency=1,BorderColor3=Color3.new(0.37647062540054,0.37647062540054,0.37647062540054),FontFace=Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal),Name="Input",Parent={25},Position=UDim2.new(0,2,0,0),Size=UDim2.new(0,50,0,16),Text="0",TextColor3=Color3.new(0.86274516582489,0.86274516582489,0.86274516582489),TextSize=14,TextXAlignment=0,}},
				...
				{28,"TextButton",{AutoButtonColor=false,BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,BorderSizePixel=0,FontFace=Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal),Name="Up",Parent={27},Size=UDim2.new(1,0,0,8),Text="",TextSize=14,}},
				...
				{33,"TextButton",{AutoButtonColor=false,BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,BorderSizePixel=0,FontFace=Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal),Name="Down",Parent={27},Position=UDim2.new(0,0,0,8),Size=UDim2.new(1,0,0,8),Text="",TextSize=14,}},
				...
				{38,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,FontFace=Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal),Name="Title",Parent={25},Position=UDim2.new(0,-40,0,0),Size=UDim2.new(0,34,1,0),Text="Green:",TextColor3=Color3.new(0.86274516582489,0.86274516582489,0.86274516582489),TextSize=14,TextXAlignment=1,}},
				...
				{40,"TextBox",{BackgroundColor3=Color3.new(0.25098040699959,0.25098040699959,0.25098040699959),BackgroundTransparency=1,BorderColor3=Color3.new(0.37647062540054,0.37647062540054,0.37647062540054),FontFace=Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal),Name="Input",Parent={39},Position=UDim2.new(0,2,0,0),Size=UDim2.new(0,50,0,16),Text="0",TextColor3=Color3.new(0.86274516582489,0.86274516582489,0.86274516582489),TextSize=14,TextXAlignment=0,}},
				...
				{42,"TextButton",{AutoButtonColor=false,BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,BorderSizePixel=0,FontFace=Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal),Name="Up",Parent={41},Size=UDim2.new(1,0,0,8),Text="",TextSize=14,}},
				...
				{47,"TextButton",{AutoButtonColor=false,BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,BorderSizePixel=0,FontFace=Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal),Name="Down",Parent={41},Position=UDim2.new(0,0,0,8),Size=UDim2.new(1,0,0,8),Text="",TextSize=14,}},
				...
				{52,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,FontFace=Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal),Name="Title",Parent={39},Position=UDim2.new(0,-40,0,0),Size=UDim2.new(0,34,1,0),Text="Hue:",TextColor3=Color3.new(0.86274516582489,0.86274516582489,0.86274516582489),TextSize=14,TextXAlignment=1,}},
				...
				{55,"TextBox",{BackgroundColor3=Color3.new(0.25098040699959,0.25098040699959,0.25098040699959),BackgroundTransparency=1,BorderColor3=Color3.new(0.37647062540054,0.37647062540054,0.37647062540054),FontFace=Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal),Name="Input",Parent={54},Position=UDim2.new(0,2,0,0),Size=UDim2.new(0,50,0,16),Text="0",TextColor3=Color3.new(0.86274516582489,0.86274516582489,0.86274516582489),TextSize=14,TextXAlignment=0,}},
				...
				{57,"TextButton",{AutoButtonColor=false,BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,BorderSizePixel=0,FontFace=Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal),Name="Up",Parent={56},Size=UDim2.new(1,0,0,8),Text="",TextSize=14,}},
				...
				{62,"TextButton",{AutoButtonColor=false,BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,BorderSizePixel=0,FontFace=Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal),Name="Down",Parent={56},Position=UDim2.new(0,0,0,8),Size=UDim2.new(1,0,0,8),Text="",TextSize=14,}},
				...
				{67,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,FontFace=Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal),Name="Title",Parent={54},Position=UDim2.new(0,-40,0,0),Size=UDim2.new(0,34,1,0),Text="Red:",TextColor3=Color3.new(0.86274516582489,0.86274516582489,0.86274516582489),TextSize=14,TextXAlignment=1,}},
				...
				{69,"TextBox",{BackgroundColor3=Color3.new(0.25098040699959,0.25098040699959,0.25098040699959),BackgroundTransparency=1,BorderColor3=Color3.new(0.37647062540054,0.37647062540054,0.37647062540054),FontFace=Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal),Name="Input",Parent={68},Position=UDim2.new(0,2,0,0),Size=UDim2.new(0,50,0,16),Text="0",TextColor3=Color3.new(0.86274516582489,0.86274516582489,0.86274516582489),TextSize=14,TextXAlignment=0,}},
				...
				{71,"TextButton",{AutoButtonColor=false,BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,BorderSizePixel=0,FontFace=Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal),Name="Up",Parent={70},Size=UDim2.new(1,0,0,8),Text="",TextSize=14,}},
				...
				{76,"TextButton",{AutoButtonColor=false,BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,BorderSizePixel=0,FontFace=Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal),Name="Down",Parent={70},Position=UDim2.new(0,0,0,8),Size=UDim2.new(1,0,0,8),Text="",TextSize=14,}},
				...
				{81,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,FontFace=Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal),Name="Title",Parent={68},Position=UDim2.new(0,-40,0,0),Size=UDim2.new(0,34,1,0),Text="Sat:",TextColor3=Color3.new(0.86274516582489,0.86274516582489,0.86274516582489),TextSize=14,TextXAlignment=1,}},
				...
				{83,"TextBox",{BackgroundColor3=Color3.new(0.25098040699959,0.25098040699959,0.25098040699959),BackgroundTransparency=1,BorderColor3=Color3.new(0.37647062540054,0.37647062540054,0.37647062540054),FontFace=Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal),Name="Input",Parent={82},Position=UDim2.new(0,2,0,0),Size=UDim2.new(0,50,0,16),Text="255",TextColor3=Color3.new(0.86274516582489,0.86274516582489,0.86274516582489),TextSize=14,TextXAlignment=0,}},
				...
				{85,"TextButton",{AutoButtonColor=false,BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,BorderSizePixel=0,FontFace=Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal),Name="Up",Parent={84},Size=UDim2.new(1,0,0,8),Text="",TextSize=14,}},
				...
				{90,"TextButton",{AutoButtonColor=false,BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,BorderSizePixel=0,FontFace=Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal),Name="Down",Parent={84},Position=UDim2.new(0,0,0,8),Size=UDim2.new(1,0,0,8),Text="",TextSize=14,}},
				...
				{95,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,FontFace=Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal),Name="Title",Parent={82},Position=UDim2.new(0,-40,0,0),Size=UDim2.new(0,34,1,0),Text="Val:",TextColor3=Color3.new(0.86274516582489,0.86274516582489,0.86274516582489),TextSize=14,TextXAlignment=1,}},
				{96,"TextButton",{AutoButtonColor=false,BackgroundColor3=Color3.new(0.2352941185236,0.2352941185236,0.2352941185236),BorderColor3=Color3.new(0.21568627655506,0.21568627655506,0.21568627655506),FontFace=Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal),Name="Cancel",Parent={1},Position=UDim2.new(1,-105,1,-28),Size=UDim2.new(0,100,0,25),Text="Cancel",TextColor3=Color3.new(0.86274516582489,0.86274516582489,0.86274516582489),TextSize=14,}},
				{97,"TextButton",{AutoButtonColor=false,BackgroundColor3=Color3.new(0.2352941185236,0.2352941185236,0.2352941185236),BorderColor3=Color3.new(0.21568627655506,0.21568627655506,0.21568627655506),FontFace=Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal),Name="Ok",Parent={1},Position=UDim2.new(1,-210,1,-28),Size=UDim2.new(0,100,0,25),Text="OK",TextColor3=Color3.new(0.86274516582489,0.86274516582489,0.86274516582489),TextSize=14,}},
	...
	Lib.NumberSequenceEditor = (function()
		local function new() -- TODO: Convert to newer class model
			...
			local guiContents = create({
				...
				{3,"TextBox",{BackgroundColor3=Color3.new(0.25098040699959,0.25098040699959,0.25098040699959),BackgroundTransparency=1,BorderColor3=Color3.new(0.37647062540054,0.37647062540054,0.37647062540054),ClipsDescendants=true,FontFace=Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal),Name="Input",Parent={2},Position=UDim2.new(0,2,0,0),Size=UDim2.new(0,58,0,20),Text="0",TextColor3=Color3.new(0.86274516582489,0.86274516582489,0.86274516582489),TextSize=14,TextXAlignment=0,}},
				{4,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,FontFace=Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal),Name="Title",Parent={2},Position=UDim2.new(0,-40,0,0),Size=UDim2.new(0,34,1,0),Text="Time",TextColor3=Color3.new(0.86274516582489,0.86274516582489,0.86274516582489),TextSize=14,TextXAlignment=1,}},
				{5,"TextButton",{AutoButtonColor=false,BackgroundColor3=Color3.new(0.2352941185236,0.2352941185236,0.2352941185236),BorderColor3=Color3.new(0.21568627655506,0.21568627655506,0.21568627655506),FontFace=Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal),Name="Close",Parent={1},Position=UDim2.new(1,-90,0,210),Size=UDim2.new(0,80,0,20),Text="Close",TextColor3=Color3.new(0.86274516582489,0.86274516582489,0.86274516582489),TextSize=14,}},
				{6,"TextButton",{AutoButtonColor=false,BackgroundColor3=Color3.new(0.2352941185236,0.2352941185236,0.2352941185236),BorderColor3=Color3.new(0.21568627655506,0.21568627655506,0.21568627655506),FontFace=Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal),Name="Reset",Parent={1},Position=UDim2.new(1,-180,0,210),Size=UDim2.new(0,80,0,20),Text="Reset",TextColor3=Color3.new(0.86274516582489,0.86274516582489,0.86274516582489),TextSize=14,}},
				{7,"TextButton",{AutoButtonColor=false,BackgroundColor3=Color3.new(0.2352941185236,0.2352941185236,0.2352941185236),BorderColor3=Color3.new(0.21568627655506,0.21568627655506,0.21568627655506),FontFace=Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal),Name="Delete",Parent={1},Position=UDim2.new(0,380,0,210),Size=UDim2.new(0,80,0,20),Text="Delete",TextColor3=Color3.new(0.86274516582489,0.86274516582489,0.86274516582489),TextSize=14,}},
				...
				{11,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,FontFace=Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal),Name="Title",Parent={10},Position=UDim2.new(0,-40,0,0),Size=UDim2.new(0,34,1,0),Text="Value",TextColor3=Color3.new(0.86274516582489,0.86274516582489,0.86274516582489),TextSize=14,TextXAlignment=1,}},
				{12,"TextBox",{BackgroundColor3=Color3.new(0.25098040699959,0.25098040699959,0.25098040699959),BackgroundTransparency=1,BorderColor3=Color3.new(0.37647062540054,0.37647062540054,0.37647062540054),ClipsDescendants=true,FontFace=Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal),Name="Input",Parent={10},Position=UDim2.new(0,2,0,0),Size=UDim2.new(0,58,0,20),Text="0",TextColor3=Color3.new(0.86274516582489,0.86274516582489,0.86274516582489),TextSize=14,TextXAlignment=0,}},
				...
				{14,"TextBox",{BackgroundColor3=Color3.new(0.25098040699959,0.25098040699959,0.25098040699959),BackgroundTransparency=1,BorderColor3=Color3.new(0.37647062540054,0.37647062540054,0.37647062540054),ClipsDescendants=true,FontFace=Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal),Name="Input",Parent={13},Position=UDim2.new(0,2,0,0),Size=UDim2.new(0,58,0,20),Text="0",TextColor3=Color3.new(0.86274516582489,0.86274516582489,0.86274516582489),TextSize=14,TextXAlignment=0,}},
				{15,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,FontFace=Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal),Name="Title",Parent={13},Position=UDim2.new(0,-40,0,0),Size=UDim2.new(0,34,1,0),Text="Envelope",TextColor3=Color3.new(0.86274516582489,0.86274516582489,0.86274516582489),TextSize=14,TextXAlignment=1,}},
			})
			local window = Lib.Window.new()
			window.Resizable = false
	...
	Lib.ColorSequenceEditor = (function() -- TODO: Convert to newer class model
		local function new()
			...
			local guiContents = create({
				...
				{8,"TextBox",{BackgroundColor3=Color3.new(0.25098040699959,0.25098040699959,0.25098040699959),BackgroundTransparency=1,BorderColor3=Color3.new(0.37647062540054,0.37647062540054,0.37647062540054),ClipsDescendants=true,FontFace=Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal),Name="Input",Parent={7},Position=UDim2.new(0,2,0,0),Size=UDim2.new(0,98,0,20),Text="0",TextColor3=Color3.new(0.86274516582489,0.86274516582489,0.86274516582489),TextSize=14,TextXAlignment=0,}},
				{9,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,FontFace=Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal),Name="Title",Parent={7},Position=UDim2.new(0,-40,0,0),Size=UDim2.new(0,34,1,0),Text="Time",TextColor3=Color3.new(0.86274516582489,0.86274516582489,0.86274516582489),TextSize=14,TextXAlignment=1,}},
				...
				{11,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,FontFace=Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal),Name="Title",Parent={10},Position=UDim2.new(0,-40,0,0),Size=UDim2.new(0,34,1,0),Text="Color",TextColor3=Color3.new(0.86274516582489,0.86274516582489,0.86274516582489),TextSize=14,TextXAlignment=1,}},
	...
	Lib.ViewportTextBox = (function()
		...
		funcs.Update = function(self)
			...
			local totalTextSize = textService:GetTextSize(text,self.TextBox.TextSize,Enum.Font.Jura,Vector2.new(999999999,100)).X
			local cursorTextSize = textService:GetTextSize(cursorText,self.TextBox.TextSize,Enum.Font.Jura,Vector2.new(999999999,100)).X
		...
		local function new()
			...
			textBox.FontFace = Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal)
			textBox.TextSize = 14
			textBox.Text = ""
	...
	Lib.Button = (function()
		...
		local function new()
			...
			b.FontFace = Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal)
			b.TextSize = 14
...
local function main()
	...
	local ModelViewer = {
		...
		AutoRotate = true,
		RotationSpeed = 0.01,
		RefreshRate = 45 -- bumper ts a little bit cuz yeah
	}
...
local function main()
	...
	Properties.NewPropEntry = function(index)
		...
		nameFrame.PropName.InputBegan:Connect(function(input)
			...
			if input.UserInputType == Enum.UserInputType.MouseMovement and not nameFrame.PropName.TextFits then
				...
				local sizeX = service.TextService:GetTextSize(dispName,14,Enum.Font.Jura,Vector2.new(math.huge,20)).X
			...
			if prop then
				...
				if prop.SpecialRow then
					...
					if prop.CategoryName then
						...
						propNameBox.FontFace = Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal)
						expand.Visible = true
	...
	Properties.InitInputBox = function()
		inputBox = create({
			...
			{2,"TextBox",{BackgroundColor3=Color3.new(0.17647059261799,0.17647059261799,0.17647059261799),BackgroundTransparency=1,BorderColor3=Color3.new(0.062745101749897,0.51764708757401,1),BorderSizePixel=0,ClearTextOnFocus=false,FontFace=Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal),Parent={1},PlaceholderColor3=Color3.new(0.69803923368454,0.69803923368454,0.69803923368454),Position=UDim2.new(0,3,0,0),Size=UDim2.new(1,-6,1,0),Text="",TextColor3=Color3.new(1,1,1),TextSize=14,TextXAlignment=0,ZIndex=2,}},
		})
	...
	Properties.InitEntryStuff = function()
		Properties.EntryTemplate = create({
			{1,"TextButton",{AutoButtonColor=false,BackgroundColor3=Color3.new(0.17647059261799,0.17647059261799,0.17647059261799),BorderColor3=Color3.new(0.1294117718935,0.1294117718935,0.1294117718935),FontFace=Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal),Name="Entry",Position=UDim2.new(0,1,0,1),Size=UDim2.new(0,250,0,22),Text="",TextSize=14,}},
			...
			{3,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,FontFace=Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal),Name="PropName",Parent={2},Position=UDim2.new(0,2,0,0),Size=UDim2.new(1,-2,1,0),Text="Anchored",TextColor3=Color3.new(1,1,1),TextSize=14,TextTransparency=0.10000000149012,TextTruncate=1,TextXAlignment=0,}},
			{4,"TextButton",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,ClipsDescendants=true,FontFace=Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal),Name="Expand",Parent={2},Position=UDim2.new(0,-20,0,1),Size=UDim2.new(0,20,0,20),Text="",TextSize=14,Visible=false,}},
			{5,"ImageLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Image="rbxassetid://5642383285",ImageRectOffset=Vector2.new(144,16),ImageRectSize=Vector2.new(16,16),Name="Icon",Parent={4},Position=UDim2.new(0,2,0,2),ScaleType=4,Size=UDim2.new(0,16,0,16),}},
			{6,"TextButton",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,BorderSizePixel=0,FontFace=Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal),Name="ToggleAttributes",Parent={2},Position=UDim2.new(1,-85,0,0),Size=UDim2.new(0,85,0,22),Text="[SETTING: OFF]",TextColor3=Color3.new(1,1,1),TextSize=14,TextTransparency=0.10000000149012,Visible=false,}},
			...
			{9,"TextButton",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,BorderSizePixel=0,FontFace=Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal),Name="ColorButton",Parent={7},Size=UDim2.new(0,20,0,22),Text="",TextColor3=Color3.new(1,1,1),TextSize=14,Visible=false,}},
			...
			{16,"TextButton",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,FontFace=Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal),Name="ValueBox",Parent={7},Position=UDim2.new(0,4,0,0),Size=UDim2.new(1,-8,1,0),Text="",TextColor3=Color3.new(1,1,1),TextSize=14,TextTransparency=0.10000000149012,TextTruncate=1,TextXAlignment=0,}},
			{17,"TextButton",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,BorderSizePixel=0,FontFace=Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal),Name="RightButton",Parent={7},Position=UDim2.new(1,-20,0,0),Size=UDim2.new(0,20,0,22),Text="...",TextColor3=Color3.new(1,1,1),TextSize=14,Visible=false,}},
			{18,"TextButton",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,BorderSizePixel=0,FontFace=Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal),Name="SettingsButton",Parent={7},Position=UDim2.new(1,-20,0,0),Size=UDim2.new(0,20,0,22),Text="",TextColor3=Color3.new(1,1,1),TextSize=14,Visible=false,}},
			...
			{20,"TextButton",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,BorderSizePixel=0,FontFace=Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal),Name="ControlButton",Parent={19},Size=UDim2.new(0,20,0,22),Text="",TextColor3=Color3.new(1,1,1),TextSize=14,}},
			...
			{24,"TextButton",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,BorderSizePixel=0,FontFace=Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal),Name="EditAttributeButton",Parent={1},Position=UDim2.new(1,-20,0,0),Size=UDim2.new(0,20,0,22),Text="",TextColor3=Color3.new(1,1,1),TextSize=14,}},
			...
			{26,"TextButton",{AutoButtonColor=false,BackgroundColor3=Color3.new(0.2352941185236,0.2352941185236,0.2352941185236),BorderSizePixel=0,FontFace=Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal),Name="RowButton",Parent={1},Size=UDim2.new(1,0,1,0),Text="Add Attribute",TextColor3=Color3.new(1,1,1),TextSize=14,TextTransparency=0.10000000149012,Visible=false,}},
	...
	Properties.Init = function() -- TODO: MAKE BETTER
		local guiItems = create({
			...
			{2,"Frame",{BackgroundColor3=Color3.new(0.20392157137394,0.20392157137394,0.20392157137394),BorderSizePixel=0,Name="ToolBar",Parent={1},Size=UDim2.new(1,0,0,22),}},
			{3,"Frame",{BackgroundColor3=Color3.new(0.14901961386204,0.14901961386204,0.14901961386204),BorderColor3=Color3.new(0.1176470592618,0.1176470592618,0.1176470592618),BorderSizePixel=0,Name="SearchFrame",Parent={2},Position=UDim2.new(0,3,0,1),Size=UDim2.new(1,-6,0,18),}},
			{4,"TextBox",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,ClearTextOnFocus=false,FontFace=Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal),Name="SearchBox",Parent={3},PlaceholderColor3=Color3.new(0.39215689897537,0.39215689897537,0.39215689897537),PlaceholderText="Search properties",Position=UDim2.new(0,4,0,0),Size=UDim2.new(1,-24,0,18),Text="",TextColor3=Color3.new(1,1,1),TextSize=14,TextXAlignment=0,}},
			{5,"UICorner",{CornerRadius=UDim.new(0,2),Parent={3},}},
			{6,"TextButton",{AutoButtonColor=false,BackgroundColor3=Color3.new(0.12549020349979,0.12549020349979,0.12549020349979),BackgroundTransparency=1,BorderSizePixel=0,FontFace=Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal),Name="Reset",Parent={3},Position=UDim2.new(1,-17,0,1),Size=UDim2.new(0,16,0,16),Text="",TextColor3=Color3.new(1,1,1),TextSize=14,}},
...
DefaultSettings = (function()
	...
	return {
		...
		Theme = {
			...
			Main1 = rgb(30,28,42),
			Main2 = rgb(24,22,34),
			Outline1 = rgb(16,15,26), -- Mainly frames
			Outline2 = rgb(60,52,96), -- Mainly button
			Outline3 = rgb(14,13,22), -- Mainly textbox
			TextBox = rgb(22,20,32),
			Menu = rgb(20,18,30),
			ListSelection = rgb(0,119,255),
			Button = rgb(48,44,74),
			ButtonHover = rgb(64,58,98),
			ButtonPress = rgb(32,30,50),
			Highlight = rgb(0,119,255),
			Text = rgb(255,255,255),
			PlaceholderText = rgb(120,118,140),
			Important = rgb(255,80,96),
			ExplorerIconMap = "",
			MiscIconMap = "",
			Syntax = {
				Text = rgb(214,214,224),
				Background = rgb(20,18,30),
				Selection = rgb(255,255,255),
				SelectionBack = rgb(0,119,255),
				Operator = rgb(214,214,224),
				Number = rgb(120,170,255),
				String = rgb(173,241,149),
				Comment = rgb(110,110,130),
				Keyword = rgb(160,110,255),
				Error = rgb(255,80,96),
				FindBackground = rgb(90,70,160),
				MatchingWord = rgb(70,66,96),
				BuiltIn = rgb(0,170,255),
				CurrentLine = rgb(34,34,58),
				LocalMethod = rgb(180,150,255),
				LocalProperty = rgb(0,150,255),
				Nil = rgb(120,170,255),
				Bool = rgb(120,170,255),
				Function = rgb(160,110,255),
				Local = rgb(160,110,255),
				Self = rgb(160,110,255),
				FunctionName = rgb(180,150,255),
				Bracket = rgb(214,214,224)
			},
		},
		ScriptViewer = {
			ShowMoreInfo = true;
...
Main = (function()
	...
	Main.SecureGui = function(gui)
		...
		gui.Name = "_DSH_".. Main.GetRandomString()
	...
	Main.IncompatibleTest = function()
		--[[local function incompatibleMessage(reason, tolerated)
			...
			t.TextWrapped = true
			t.TextScaled = true
			t.Text = "\n\n\n\n\n\n\n\nHello Skidsploit user,\nZinnia, Gato and the Secret Service does not approve of Dex being used on your skidsploit.\nPlease consider getting something better.\n\nIncompatible Reason: "..reason.."\n\n\n\n\n\n\n\n"
	...
	Main.LoadSettings = function()
		local s, data = pcall(env.readfile or error, "DexSharpSettings.json")
	...
	Main.CreateIntro = function(initStatus) -- TODO: Must theme and show errors
		local gui = create({
			...
			{5,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,FontFace=Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal),Name="Title",Parent={3},Position=UDim2.new(0,-190,0,15),Size=UDim2.new(0,100,0,50),Text="Dex#",TextColor3=Color3.new(1,1,1),TextSize=50,TextTransparency=1,}},
			{6,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,FontFace=Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal),Name="Desc",Parent={3},Position=UDim2.new(0,-230,0,60),Size=UDim2.new(0,180,0,25),Text="Just a Debugging Suite.",TextColor3=Color3.new(1,1,1),TextSize=18,TextTransparency=1,}},
			{7,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,FontFace=Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal),Name="StatusText",Parent={3},Position=UDim2.new(0,20,0,110),Size=UDim2.new(0,180,0,25),Text="Fetching API",TextColor3=Color3.new(1,1,1),TextSize=14,TextTransparency=1,}},
			...
			{11,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,FontFace=Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal),Name="Creator",Parent={2},Position=UDim2.new(1,-110,1,-20),Size=UDim2.new(0,105,0,20),Text="Modded by Gato.",TextColor3=Color3.new(1,1,1),TextSize=14,TextXAlignment=1,}},
			{12,"UIGradient",{Parent={11},Transparency=NumberSequence.new({NumberSequenceKeypoint.new(0,1,0),NumberSequenceKeypoint.new(1,1,0),}),}},
			{13,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,FontFace=Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal),Name="Version",Parent={2},Position=UDim2.new(1,-110,1,-35),Size=UDim2.new(0,105,0,20),Text=Main.Version,TextColor3=Color3.new(1,1,1),TextSize=14,TextXAlignment=1,}},
		...
		local ti = TweenInfo.new(0.4,Enum.EasingStyle.Cubic,Enum.EasingDirection.Out)
		...
		local progressTI = TweenInfo.new(0.25,Enum.EasingStyle.Cubic,Enum.EasingDirection.Out)
		...
		local function close()
			...
			tweenNumber(100,TweenInfo.new(0.4,Enum.EasingStyle.Cubic,Enum.EasingDirection.Out),function(val)
				val = val/250
				local start = NumberSequenceKeypoint.new(0,0)
	...
	Main.CreateApp = function(data)
		...
		local ySize = service.TextService:GetTextSize(data.Name,14,Enum.Font.Jura,Vector2.new(62,999999)).Y
	...
	Main.SetMainGuiOpen = function(val)
		...
		TweenSize(Main.MainGui.OpenButton.MainFrame,val and UDim2.new(0,224,0,200) or UDim2.new(0,0,0,0),Enum.EasingDirection.Out,Enum.EasingStyle.Cubic,0.2,true)
		--Main.MainGui.OpenButton.BackgroundTransparency = val and 0 or (Lib.CheckMouseInGui(Main.MainGui.OpenButton) and 0 or 0.2)
		service.TweenService:Create(Main.MainGui.OpenButton,TweenInfo.new(0.2,Enum.EasingStyle.Cubic,Enum.EasingDirection.Out),{BackgroundTransparency = val and 0 or (Lib.CheckMouseInGui(Main.MainGui.OpenButton) and 0 or 0.2)}):Play()
	...
	Main.CreateMainGui = function()
		local gui = create({
			...
			{2,"TextButton",{AnchorPoint=Vector2.new(0.5,0),AutoButtonColor=false,BackgroundColor3=Color3.new(0.17647059261799,0.17647059261799,0.17647059261799),BorderSizePixel=0,FontFace=Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal),Name="OpenButton",Parent={1},Position=UDim2.new(0.5,0,0,2),Size=UDim2.new(0,55,0,32),Text="Dex#",TextColor3=Color3.new(1,1,1),TextSize=16,TextTransparency=0.20000000298023,}},
			{3,"UICorner",{CornerRadius=UDim.new(0,4),Parent={2},}},
			...
			{10,"TextButton",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,FontFace=Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal),Name="Settings",Parent={6},Position=UDim2.new(1,-48,0,0),Size=UDim2.new(0,24,1,0),Text="",TextColor3=Color3.new(1,1,1),TextSize=14,}},
			...
			{12,"TextButton",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,FontFace=Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal),Name="Information",Parent={6},Position=UDim2.new(1,-24,0,0),Size=UDim2.new(0,24,1,0),Text="",TextColor3=Color3.new(1,1,1),TextSize=14,}},
			...
			{18,"TextButton",{AutoButtonColor=false,BackgroundColor3=Color3.new(0.2352941185236,0.2352941185236,0.2352941185236),BorderSizePixel=0,FontFace=Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal),Name="Main",Parent={17},Size=UDim2.new(1,0,0,60),Text="",TextColor3=Color3.new(0,0,0),TextSize=14,}},
			...
			{20,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,BorderSizePixel=0,FontFace=Font.new([[rbxasset://fonts/families/Jura.json]], Enum.FontWeight.Light, Enum.FontStyle.Normal),Name="AppName",Parent={18},Position=UDim2.new(0,2,0,38),Size=UDim2.new(1,-4,1,-40),Text="Explorer",TextColor3=Color3.new(1,1,1),TextSize=14,TextTransparency=0.10000000149012,TextTruncate=1,TextWrapped=true,TextYAlignment=0,}},
		...
		openButton.InputBegan:Connect(function(input)
			if input.UserInputType == Enum.UserInputType.MouseMovement or input.UserInputType == Enum.UserInputType.Touch then
				service.TweenService:Create(Main.MainGui.OpenButton,TweenInfo.new(0,Enum.EasingStyle.Cubic,Enum.EasingDirection.Out),{BackgroundTransparency = 0}):Play()
			end
		end)

		openButton.InputEnded:Connect(function(input)
			if input.UserInputType == Enum.UserInputType.MouseMovement or input.UserInputType == Enum.UserInputType.Touch then
				service.TweenService:Create(Main.MainGui.OpenButton,TweenInfo.new(0,Enum.EasingStyle.Cubic,Enum.EasingDirection.Out),{BackgroundTransparency = Main.MainGuiOpen and 0 or 0.2}):Play()
			end
		end)
	...
	Main.SaveCurrentSettings = function()
		if writefile then
			writefile("DexSharpSettings.json", Main.ExportSettings())
		end
	end
	...
	Main.Init = function()
		...
		if isfile and not isfile("DexSharpSettings.json") then
			Main.SaveCurrentSettings()
		end
	...
	Main.Uninit = function()
		...
		for _, gui in pairs(Main.GetSecureContainer():GetChildren()) do
			if string.sub(gui.Name,1,5) == "_DSH_" then -- DSH stands for DexSharp
				gui:Destroy()
			end
		end
	end
